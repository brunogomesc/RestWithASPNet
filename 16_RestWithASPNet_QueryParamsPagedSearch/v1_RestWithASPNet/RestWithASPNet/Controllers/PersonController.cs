...
namespace RestWithASPNet.Controllers
{
    ...
    public class PersonController : ControllerBase
    {
        ...
        public IActionResult List([FromQuery] string name, string sortDirection, int pageSize, int page)
        {
        ...
        [ProducesResponseType(401)]
        [TypeFilter(typeof(HyperMediaFilter))]
        public IActionResult List([FromQuery] string firstName, string lastName)
        {
